    ...
    <div className='hero'>
      <div className="hSection left">
        ...
        <motion.div variants={awardVariants} initial="initial" animate="animate" className="awards">
          ...
          <motion.p variants={awardVariants}>Awarded for standout creative work on <strong>Fiverr, Behance, and Dribbble</strong>. Known for clean design, fast delivery, and a passion for turning ideas into high-impact visuals.</motion.p>
      ...
      <motion.a href="/#contact" className="contactLink" animate={{ x: [200, 0], opacity: [0, 1]}} transition={{ duration: 2}}>
        <motion.div className="contactButton" animate={{ rotate: [0, 360] }} transition={{ duration: 10, repeat: Infinity, ease: "linear"}}>
            <svg viewBox="0 0 200 200" width="150" height="150">
              <circle cx="100" cy="100" r="90" fill="#90EE90" />
              <path
                id="innerCirclePath"
                fill="none"
